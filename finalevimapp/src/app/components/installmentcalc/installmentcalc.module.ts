...
import { InstallmentCalcRoutingModule } from './installmentcalc-routing.module';
...
@NgModule({
  declarations: [ calculateformComponent , CalculatesComponent , calculateviewComponent],
  imports: [
    NgSelectModule,
    FormsModule,
    ReactiveFormsModule,
    CommonModule,
    InstallmentCalcRoutingModule,
    CountToModule,
    NgxDatatableModule,
    Ng2SmartTableModule,
...
export class InstallmentCalcModule { }

...
export class UsersComponent implements OnInit , OnDestroy{
  ...
  editAgent(value){
    this.router.navigate(['/usersetting/userform/'+value]);
  }

  addUserLink(){

    this.router.navigate(['/usersetting/userform/new']);
  ...
  ngOnInit() {
    ...
    this.columns = [
      ...
      { prop: 'sm' , name: 'Soyisim', sortable: true, flexGrow: 1, headerTemplate: this.hdrTpl },
